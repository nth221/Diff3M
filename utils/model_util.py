...
from models.diffusions import SpacedDiffusion, space_timesteps
from models.diff3M_unet import Diff3M_UNetModel
...
def create_model_and_diffusion(
    ...
    model = create_model(
        ...
        one_class=one_class,
        demo_cat_num=demo_cat_num,
        ehr_cat_num=ehr_cat_num,
        exp_name=exp_name,
...
def create_model(
    ...
    return Diff3M_UNetModel(
        image_size=image_size,
        in_channels=number_in_channels,
        model_channels=num_channels,
        out_channels=number_in_channels * 2,#12,#(3 if not learn_sigma else 6),
